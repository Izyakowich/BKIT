...
bot = telebot.TeleBot('5705343070:AAH6DVQ_BkdFNTGs2W-CqbINFS9nHEek25s')
...
#     elif message.text == "photo" or "Photo":
#         photo = open('загрузка.jpeg', 'rb')
#         bot.send_photo(message.chat.id, photo)
#     else:
#         bot.send_message(message.chat.id, "You stupid dick", parse_mode='html')
